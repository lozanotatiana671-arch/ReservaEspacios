...
<%@ page import="java.util.*, com.reservas.Consulta" %>
  ...
  <div class="container-fluid">
    <div class="row" style="margin-right: -20px;">
      ...
      <main class="col-md-10 content-area">
        <h2><i class="bi bi-envelope"></i> Consultas de Usuarios</h2>
          ...
          <table class="table mb-0 table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><%= c.getNombre() %></td>
                <td><%= c.getCorreo() %></td>
                <td class="text-left"><%= c.getMensaje() %></td>
              </tr>
              <%
                    }
                } else {
              ...
              <tr>
                <td colspan="4" class="text-center py-3">
                  <i class="bi bi-inbox"></i> No hay consultas registradas
                </td>
              </tr>
              <%
                }
